...
local theme_path = os.getenv("HOME") .. "/.config/awesome/just1602/theme.lua"
...
awful.tag({"email", "irc", "slack", "signal", "±", "~"}, screen[1], awful.layout.layouts[1])
...
awful.rules.rules = {
    ...
    { rule_any = {
     ...
     { rule = { class = "Tweetdeck" },
       properties = { screen = 1, tag = "twitter" } },
     { rule = { class = "Chromium" },
