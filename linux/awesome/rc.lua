...
tags = {}
tags[1] = awful.tag({ "www", "dev", "music", "files", "foo" }, 1, layouts[1])
tags[2] = awful.tag({ "mail", "irc", "bar" }, 2, layouts[1])
-- for s = 1, screen.count() do
...
globalkeys = awful.util.table.join(
    ...
    awful.key({}, "XF86AudioNext", function() awful.util.spawn_with_shell("mpd next") end)
)
...
awful.util.spawn_with_shell("setxkbmap -variant fr -layout ca")
-- }}}
